<template>
  <div>
    ...
    <form @submit.prevent="register" class="section">
      <div class="container">
        <div class="field">
        ...
        <div class="container">
          ...
          <button class="button-user" @click="goToLogin">Already have an account? Log in</button>
        </div>
  ...
  methods: {
    ...
    register () {
      if (this.password==this.passwordr){
        ...
        .then(()=> this.$bvModal.hide('modal-register'))
